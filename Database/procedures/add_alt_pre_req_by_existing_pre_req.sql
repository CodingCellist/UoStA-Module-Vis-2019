-- Add an alternative to an existing pre-requisite by knowing one other module
-- in the given year and semester which is a pre-requisite.
CREATE PROCEDURE teh6_2019_summer_project.add_alt_pre_req_by_existing_pre_req(
...
BEGIN
	...
	AND complete_requisites.`type` = 'Pre'
